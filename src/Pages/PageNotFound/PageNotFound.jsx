    ...
    return (
        <div className='min-h-screen flex flex-col'>
            ...
            <div className='grow content-center text-center'>
                ...
                <button className='px-6 py-2 rounded-full text-blue-600 border border-blue-600 mr-2 cursor-pointer'>Go Back</button>
                <button className='px-6 py-2 rounded-full bg-blue-600 text-white border border-blue-600 cursor-pointer'>Go Home</button>
            </div>
        </div>
    );
};
